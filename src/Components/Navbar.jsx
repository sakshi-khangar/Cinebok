...
//   // Sync auth + notifications + profile image
//   const sync = () => {
//     setIsLoggedIn(localStorage.getItem("isLoggedIn") === "true");
//     setUser(JSON.parse(localStorage.getItem("user") || "null"));

//     // ✅ NEW: profile image sync
//     const sync = () => {
//   setIsLoggedIn(localStorage.getItem("isLoggedIn") === "true");
...
//   const merged = [...stored, ...bookingNotifs].reduce((acc, n) => {
...
//             Home {isActive("/") && <span className="active-dot" />}
//           </Link>
//         </li>
//         <li>
...
//             Offers {isActive("/offers") && <span className="active-dot" />}
//           </Link>
//         </li>
//         <li>
//           <Link to="/events" className={`nav-link ${isActive("/events") ? "active" : ""}`}>
//             Events {isActive("/events") && <span className="active-dot" />}
//           </Link>
//         </li>
//       </ul>
...
//               <p className="filter-section-title" style={{ marginTop: "12px" }}>
//                 🌐 Language
//               </p>
...
//           <button className="icon-btn badge-btn" onClick={() => setShowNotifications(!showNotifications)}>
...
//                     }}
//                   >
//                     🎟 My Bookings <span className="menu-badge">{bookings.length}</span>
//                   </button> */}
...
//                     }}
//                   >
//                     ❤️ Wishlist <span className="menu-badge">{wishlist.length}</span>
//                   </button> */}
