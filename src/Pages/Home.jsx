...
//   setAdminMovies(savedMovies);
// }, []);

//   const [activeGenre, setActiveGenre] = useState("All");
//   const allMovies = [...movies, ...adminMovies];
...
//               Try another city, language or genre
//             </p>
...
//             <p>
//               Your one-stop destination for booking movies
//               across Nagpur, Mumbai & Pune.
//               Fast, easy and secure movie booking platform.
//             </p>

//             <div className="footer-social">

//   <a
//     href="https://instagram.com/sakshik173/?utm_source=qr&r=nametag"
//     target="_blank"
//     rel="noreferrer"
...
//   <a
//     href="https://github.com/sakshi-khangar"
//     target="_blank"
//     rel="noreferrer"
//     className="social-btn"
//   >
...
//   <a
//     href="https://linkedin.com/in/sakshi-khangar-01798731b"
//     target="_blank"
//     rel="noreferrer"
//     className="social-btn"
//   >
...
//   <a
//     href="mailto:khangars095@gmail.com"
//     className="social-btn"
//   >
//     <MdEmail />
//   </a>
...
//           <p>
//             © 2025 CineBook. Made with ❤️ in Nagpur
//           </p>
...
function Home({ selectedCity, selectedLanguage, searchTerm, isLoggedIn }) {
...
const searchQuery =
  ...
  // const handleMovieClick = (movieId) => {
  //   const loggedIn = isLoggedIn === true || localStorage.getItem("isLoggedIn") === "true";
  ...
  const filteredMovies = allMovies.filter((movie) => {
    const matchCity     = movie.city === selectedCity;
  ...
  movie.title.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    return matchCity && matchLanguage && matchSearch && matchGenre;
  });
